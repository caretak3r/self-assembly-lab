...
```
Self-assembly
├── Molecular / DNA          (Seeman, Winfree, Rothemund, Yin bricks, colloids)
├── Algorithmic theory       (aTAM, Doty, multifarious tiles)
├── Swarm robotics           (Kilobots, particle robots)
└── Modular / programmable matter (Claytronics, MRR surveys, reconfiguration algs)
```
