...
```mermaid
flowchart TD
  SA["Self-assembly"] --> DNA["Molecular / DNA — Seeman, Winfree, Rothemund, Yin bricks, colloids"]
  SA --> ALG["Algorithmic theory — aTAM, Doty, multifarious tiles"]
  SA --> SWARM["Swarm robotics — Kilobots, particle robots"]
  SA --> MRR["Modular / programmable matter — Claytronics, MRR surveys, reconfiguration algs"]
```
